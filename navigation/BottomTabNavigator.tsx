...
import { TabBarIconType, MainBottomTabNavigatorParamList } from '../constants/types/Types';
...
const BottomTab = createMaterialBottomTabNavigator<MainBottomTabNavigatorParamList>();
const purple = '#694fad';
...
const screenInfo: ScreenInfo[] = [
  // ProductsScreen
  {
    ...
    options: {
      ...
      tabBarIcon: ({ focused, color }: TabBarIconType): React.ReactElement => (
        <TabBarIcon focused={focused} name="baby-carriage" color={color} />
      ),
    },
  },
  // Orders Screen
  {
    ...
    options: {
      ...
      // eslint-disable-next-line react/display-name
      tabBarIcon: ({ focused, color }: TabBarIconType): React.ReactElement => (
        <TabBarIcon focused={focused} name={focused ? 'box-open' : 'box'} color={color} />
      ),
    },
  },
  // Exchanges Screen
  {
    ...
    options: {
      ...
      // eslint-disable-next-line react/display-name
      tabBarIcon: ({ focused, color }: TabBarIconType): React.ReactElement => (
        <TabBarIcon focused={focused} name="sync-alt" color={color} />
      ),
    },
  },
  // Chart Screen
  {
    ...
    options: {
      ...
      // eslint-disable-next-line react/display-name
      tabBarIcon: ({ focused, color }: TabBarIconType): React.ReactElement => (
        <TabBarIcon focused={focused} name="chart-bar" color={color} />
      ),
    },
  },
  // Profile Screen
