...
import { ImageModalProps } from '../../constants/types/Types';
...
export default function ImageModalScreen({ navigation, route }: ImageModalProps) {
  ...
  const _onPinchHandlerStateChange = (event: any): void => {
  ...
  const _onPanGestureStateChange = (event: any): void => {
    if (event.nativeEvent.oldState === State.ACTIVE) {
